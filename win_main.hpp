...
private:
    std::string id;
    std::thread *hilo_exp,*hilo, *hilo2, *hilo3, *hilo4, *hilo5, *hilo6, *hilo7, *hilo8, *hilo9, *hilo10; 
    GMutex mutex;
    ...
    Gtk::RadioButton *radiobutton4, *radiobutton5;
    ...
    Gtk::Button *btn_export_excel,*btn_export_pdf;
    Gtk::MenuButton *btn_cat_export;
    Gtk::FileChooserButton  *btn_file_chooser;
    ...
    //Orden
    Gtk::Entry *ety_orden_lugar,*ety_orden_fecha,*ety_cb_unidad,*ety_cb_empresa,*ety_cb_operador,*ety_cb_ruta;
    Gtk::Entry *ety_orden_razon,*ety_orden_rfc,*ety_orden_giro,*ety_orden_direccion,*ety_orden_domicilio,*ety_orden_tarifa,*ety_orden_precio,*ety_orden_tipo;
    Gtk::Entry *ety_orden_nombre,*ety_orden_rfc1,*ety_orden_imss,*ety_orden_licen,*ety_orden_curp;
    Gtk::Entry *ety_orden_marca,*ety_orden_modelo,*ety_orden_placas,*ety_orden_tarjeta,*ety_orden_verificacion;
    Gtk::Entry *ety_orden_origen,*ety_orden_destino,*ety_orden_distancia,*ety_orden_estimado;

    Gtk::ComboBoxText *cb_orden_unidad,*cb_orden_empresa,*cb_orden_operador,*cb_orden_ruta;
    Gtk::SpinButton *spin_orden_efectivo,*spin_orden_vales,*spin_orden_iave,*spin_orden_total;
    ...
    Gtk::Popover *pop_cal,*pop_orden_fecha;
    Gtk::TreeModelFilter *filter1;
    Gtk::Calendar *cal;
    ...
    bool on_timeout();
    void on_ety_orden_fecha_focus_in_event();
    ...
    void crea_xls_tractor(std::string file);
    void crea_xls_remolque(std::string file);
    void crea_xls_operador(std::string file);
    void crea_xls_ayudante(std::string file);
    void crea_xls_poblacion(std::string file);
    void crea_xls_ruta(std::string file);
    void crea_xls_producto(std::string file);
    void crea_xls_cliente(std::string file);
    void crea_xls_tarifa(std::string file);

    void crea_pdf_tractor(std::string file);
    void crea_pdf_remolque(std::string file);
    void crea_pdf_operador(std::string file);
    void crea_pdf_ayudante(std::string file);
    void crea_pdf_poblacion(std::string file);
    void crea_pdf_ruta(std::string file);
    void crea_pdf_producto(std::string file);
    void crea_pdf_cliente(std::string file);
    void crea_pdf_tarifa(std::string file);
    ...
    Gtk::TreeModel::Row row4;
    Gtk::TreeModel::Row row5;
    Gtk::TreeModel::Row row6;
    Gtk::TreeModel::Row row7;
    Gtk::TreeModel::Row row8;
    Gtk::TreeModel::Row row9;
