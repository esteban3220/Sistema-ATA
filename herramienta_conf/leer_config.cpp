...
void config::escribe_configuracion(std::string _user, std::string _password, std::string _server, std::string _socket)
{
	std::cout << std::endl;
...
void config::lee_configuracion()
{
	...
	this->socket = myFile.get_string(4);
}
